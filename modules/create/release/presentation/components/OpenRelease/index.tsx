import useOpenReleaseController, {
  OpenReleaseProps,
} from "./OpenRelease.controller";
import styles from "./OpenRelease.module.scss";
...
export default function OpenReleaseComponent(props: OpenReleaseProps) {
  const {} = useOpenReleaseController(props);
